...
public class servicio {
    ...
    @WebMethod(operationName = "generarReporteRangoFecha")
    public void generarReporteRangoFecha(@WebParam(name ="fechas") String fecha){
        String fechas[] = fecha.split("-");
        IMP.reporteTopUsuarios(fechas[0], fechas[1]);
    }
    ...
    public String listaFacturas(@WebParam(name = "nickname") String nickname) {
        return IMP.listaDeFacturas(nickname);        
    }
