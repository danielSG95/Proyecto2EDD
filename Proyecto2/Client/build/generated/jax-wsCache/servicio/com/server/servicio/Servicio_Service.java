 ...
 * 
 */
@WebServiceClient(name = "servicio", targetNamespace = "http://servicio.server.com/", wsdlLocation = "http://localhost:8080/TiendaServer/servicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://servicio.server.com/", "servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/TiendaServer/servicio?wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://servicio.server.com/", "servicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.server.com/", "servicioPort"), Servicio.class, features);
    }
